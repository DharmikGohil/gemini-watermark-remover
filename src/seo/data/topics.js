/**
 * Structured topic data for programmatic SEO pages.
 * Each topic generates a unique page with intent-matched content.
 * 
 * Hub-and-spoke model:
 *   - Hub pages: category landing pages (e.g., /guides/, /tools/)
 *   - Spoke pages: individual topic pages linked from hubs
 * 
 * To add pages at scale, append entries here. The SSG pipeline
 * handles routing, metadata, schema markup, and internal linking.
 */

// Topic categories (hubs)
export const CATEGORIES = {
  guides: {
    slug: 'guides',
    title: 'Gemini AI Image Guides',
    description: 'Step-by-step guides for working with Gemini AI-generated images, watermarks, and metadata.',
    icon: 'book',
  },
  tools: {
    slug: 'tools',
  ...
  learn: {
    ...
    description: 'Educational resources about how AI watermarking works, including SynthID, alpha blending, and EXIF metadata.',
    icon: 'graduation-cap',
  },
};

/**
 * Individual topic pages (spokes).
 * Each entry produces one HTML page at /{category}/{slug}/
 * 
 * Required fields:
 *   slug, category, title, heading, description, content, faqs
 * 
 * The `relatedSlugs` array drives internal linking (spoke-to-spoke).
 * The `schemaType` determines JSON-LD structured data.
 */
export const TOPICS = [
  {
  ...
  },
  {
    ...
    description: 'Compare Google SynthID invisible steganographic watermarks with visible alpha-blended watermarks in Gemini AI images. Understand what can and cannot be removed.',
    schemaType: 'Article',
  ...
  },
  {
    ...
    description: 'Learn how to verify if an image was generated by Google Gemini AI by examining its EXIF metadata, including the "Made with Google AI" credit field.',
    schemaType: 'Article',
  ...
  },
  {
    ...
    description: 'Process multiple Gemini AI images at once with Clearmark\'s batch mode. Remove watermarks from dozens of images simultaneously and download as a ZIP file.',
    schemaType: 'Article',
  ...
  },
  {
    ...
    description: 'Install the Clearmark Tampermonkey userscript to automatically remove watermarks from Gemini AI images as they appear on gemini.google.com.',
    schemaType: 'Article',
...
/**
 * Lookup helpers for the SSG pipeline
 */
